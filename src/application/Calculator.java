...
//	}
	...
	public void calculate() {
		...
		if (spannung != 0 && strom != 0) {
			...
			System.out.println("Leistung (" + leistung + ") wird aus Spannung " + spannung + " & Strom " + strom + " berechnet.");
			widerstand = rAusUundI(spannung, strom);
			System.out.println("Widerstand (" + widerstand + ") wird aus Spannung " + spannung + " & Strom " + strom + " berechnet.");
			System.out.println("______________________________________");
		}else
		if (spannung != 0 && widerstand != 0) {
			leistung = pAusUundR(spannung, widerstand);
			System.out.println("Leistung (" + leistung + ") wird aus Spannung " + spannung + " & Widerstand " + widerstand + " berechnet.");
			strom = iAusUundR(spannung, widerstand);
			System.out.println("Strom (" + strom + ") wird aus Spannung " + spannung + " & Widerstand " + widerstand + " berechnet.");
			System.out.println("______________________________________");
		}else
		if (widerstand != 0 && strom != 0) {
			leistung = pAusRundI(widerstand, strom);
			System.out.println("Leistung (" + leistung + ") wird aus Widerstand " + widerstand + " & Strom " + strom + " berechnet.");
			spannung = uAusRundI(widerstand, strom);
			System.out.println("Spannung (" + spannung + ") wird aus Widerstand " + widerstand + " & Strom " + strom + " berechnet.");
			System.out.println("______________________________________");
		}
